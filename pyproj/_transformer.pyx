    ...
    def _transform_bounds(
        ...
        with nogil:
            ...
            for iii in range(side_pts):
                ...
                # handle antimeridian
                if proj_degree_input(self.projobj, pj_direction):
                    if x_boundary_array.data[iii] > 180.0:
                        x_boundary_array.data[iii] -= 360.0
                    if x_boundary_array.data[iii + side_pts] < -180.0:
                        x_boundary_array.data[iii] += 360.0
